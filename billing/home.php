            ...
            <form action="" id="manage-order">
                ...
                <div class="bg-white" id='o-list'>
                            <div class="d-flex w-100 bg-dark mb-1">
                                <label for="" class="text-white"><b>ID Number.</b></label>
        ...
        <div class="col-lg-8  p-field">
            ...
            <div class="card-footer bg-dark  border-primary">
                <div class="row justify-content-center">
                    <div class="btn btn btn-sm col-sm-3 btn-primary mr-2" type="button" id="pay">Pay Cash</div>
                    <div class="btn btn btn-sm col-sm-3 btn-primary" type="button" id="save_order">Pay Via Portal</div>
                </div>
            </div>
            </div>      			
        </div>
